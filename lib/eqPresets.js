...
class EQPresetManager {
    ...
    saveEQ(channel, presetIdx, name = '') {
        ...
        // F0 43 10 3E 7F 10 21 [CH] [ID] 00 00 F7
        const storeMsg = [0xF0, 0x43, 0x10, 0x3E, 0x7F, 0x10, 0x21, chIdx & 0x7F, id & 0x7F, 0x00, 0x00, 0xF7];
        ...
        setTimeout(() => {
            ...
            // Name set usually uses 41 00 ... Wait, does it need channel?
            // "Name of Input Channel Library" -> 41 00 ID... NO channel in ID usually for Library names.
            // But let's check the spec if possible or stick to 00 if it works. 
            // The original code had 41 00. Assuming name command is Global for the ID.
